       ...
       return (           
		  ...
		  <View style={styles.container}>       
				 ...
				 <View style={{alignItems:'center', flex:0.18, justifyContent: 'flex-end', }}>
					<Text style={{color:'#777',fontSize:16, marginBottom:10}}>{'What is your Sanpchat Username'}</Text>
				 </View> 
				 ...
				 <View style={{alignItems:'center', flex:0.22, justifyContent: 'center'}}>
					 <View style={styles.addnew}>   
						  <TouchableOpacity style={{paddingLeft:30,paddingRight:30}} onPress={this.login_check}>				
