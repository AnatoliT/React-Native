...
var args19164 = [];
var len__17913__auto___19168 = arguments.length;
var i__17914__auto___19169 = (0);
while(true){
if((i__17914__auto___19169 < len__17913__auto___19168)){
args19164.push((arguments[i__17914__auto___19169]));

var G__19170 = (i__17914__auto___19169 + (1));
i__17914__auto___19169 = G__19170;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___19172 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__19163_SHARP_){
if(!((p1__19163_SHARP_ == null))){
if((false) || (p1__19163_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___19172){
var not_reactive_19173 = temp__4425__auto___19172;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_19173);
} else {
}
} else {
}
