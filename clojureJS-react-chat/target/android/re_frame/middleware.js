...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__19215){
var args = cljs.core.seq(arglist__19215);
...
return cljs.core.get_in.call(null,new_db,p1__19216_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__19217_SHARP_){
return cljs.core.get_in.call(null,db,p1__19217_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__19218__i < G__19218__a.length) {G__19218__a[G__19218__i] = arguments[G__19218__i + 2]; ++G__19218__i;}
  in_paths = new cljs.core.IndexedSeq(G__19218__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__19219){
var f = cljs.core.first(arglist__19219);
arglist__19219 = cljs.core.next(arglist__19219);
var out_path = cljs.core.first(arglist__19219);
var in_paths = cljs.core.rest(arglist__19219);
