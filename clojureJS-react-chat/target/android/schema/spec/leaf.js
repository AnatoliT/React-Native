...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__17471__auto__,k24036,else__17472__auto__){
var self__ = this;
var this__17471__auto____$1 = this;
var G__24038 = (((k24036 instanceof cljs.core.Keyword))?k24036.fqn:null);
switch (G__24038) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k24036,else__17472__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__24035){
var self__ = this;
var G__24035__$1 = this;
return (new cljs.core.RecordIter((0),G__24035__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__17476__auto__,k__17477__auto__,G__24035){
var self__ = this;
var this__17476__auto____$1 = this;
var pred__24039 = cljs.core.keyword_identical_QMARK_;
var expr__24040 = k__17477__auto__;
if(cljs.core.truth_(pred__24039.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__24040))){
return (new schema.spec.leaf.LeafSpec(G__24035,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__17477__auto__,G__24035),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__17468__auto__,G__24035){
var self__ = this;
var this__17468__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__24035,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__24037){
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__24037),null,cljs.core.dissoc.call(null,G__24037,new cljs.core.Keyword(null,"pre","pre",2118456869)),null));
});
